...
* If using a frequentist framework, consider acceptable levels of Type-I and Type-II errors
    ...
    - avoid the use of *//**//*** to indicate significance at varying levels 
...
* Report all of the information from statistical tests--don't make reviewers and editors guess
